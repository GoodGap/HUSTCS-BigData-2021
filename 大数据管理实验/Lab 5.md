...
![image-20231027210001069](/大数据处理实验/pic/image-20231027210001069.png)
...
![image-20231027211143032](/大数据处理实验/pic/image-20231027211143032.png)
...
![image-20231027212117035](/大数据处理实验/pic/image-20231027212117035.png)

在原先的会话中再次使用select * from test;查看当前表内的数据，可以发现已经成功更新：

![image-20231027212154926](/大数据处理实验/pic/image-20231027212154926.png)



再在第一个会话中更新（先不commit）：update test set flag=100 where id=4;

![image-20231030134019145](/大数据处理实验/pic/image-20231030134019145.png)

到第二个会话中查询当前数据，发现此时无变化

![image-20231030134054717](/大数据处理实验/pic/image-20231030134054717.png)

然后回到第一个终端commit

![image-20231030134123440](/大数据处理实验/pic/image-20231030134123440.png)

![image-20231030134140200](/大数据处理实验/pic/image-20231030134140200.png)
...
![image-20231030201847235](/大数据处理实验/pic/image-20231030201847235.png)
...
![image-20231030173616390](/大数据处理实验/pic/image-20231030173616390.png)

三台服务器分别创建数据存放的目录：

![image-20231030202907668](/大数据处理实验/pic/image-20231030202907668.png)

![image-20231030203055209](/大数据处理实验/pic/image-20231030203055209.png)

![image-20231030203108454](/大数据处理实验/pic/image-20231030203108454.png)



分别完成shard1和shard2的replica set配置：

![image-20231030203431445](/大数据处理实验/pic/image-20231030203431445.png)

![image-20231030203716412](/大数据处理实验/pic/image-20231030203716412.png)
...
![image-20231030203625817](/大数据处理实验/pic/image-20231030203625817.png)

![image-20231030203948915](/大数据处理实验/pic/image-20231030203948915.png)
...
![image-20231030204306314](/大数据处理实验/pic/image-20231030204306314.png)
...
![image-20231030190434038](/大数据处理实验/pic/image-20231030190434038.png)

（上图为报错，因为addshard字段内严格不允许出现空格）

![image-20231030204648758](/大数据处理实验/pic/image-20231030204648758.png)
...
![image-20231030191109715](/大数据处理实验/pic/image-20231030191109715.png)

激活分片：

sh.enableSharding("testdb")

![image-20231030204801046](/大数据处理实验/pic/image-20231030204801046.png)

使用sh.status()查看数据库当前情况：

![image-20231030204830940](/大数据处理实验/pic/image-20231030204830940.png)

创建一个新的集合testc：

db.createCollection("testc")

![image-20231030214116931](/大数据处理实验/pic/image-20231030214116931.png)
...
![image-20231030214328897](/大数据处理实验/pic/image-20231030214328897.png)

通过db.testc.find()可以查看当前集合中的数据：

![image-20231030214407097](/大数据处理实验/pic/image-20231030214407097.png)
...
![image-20231030214912129](/大数据处理实验/pic/image-20231030214912129.png)

删除一条数据：

db.getSiblingDB("testdb").getCollection("testc").deleteOne({ _id: 3 })

![image-20231030215102075](/大数据处理实验/pic/image-20231030215102075.png)

再回到test-0001服务器，通过db.testc.find()查看当前集合中的数据：

![image-20231030215201365](/大数据处理实验/pic/image-20231030215201365.png)
